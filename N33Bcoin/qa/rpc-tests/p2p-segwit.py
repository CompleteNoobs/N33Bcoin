...
class SegWitTest(N33BcoinTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, n33bcoind delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let n33bcoind fill it in.
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older n33bcoind's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-n33bcoind> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active n33bcoind
