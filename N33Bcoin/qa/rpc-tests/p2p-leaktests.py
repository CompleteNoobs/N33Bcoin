#!/usr/bin/env python3
# Copyright (c) 2017 The N33Bcoin Core developers
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if n33bcoind ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(N33BcoinTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 1
