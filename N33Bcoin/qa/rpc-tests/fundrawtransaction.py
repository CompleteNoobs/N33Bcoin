...
class RawTransactionsTest(N33BcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid n33bcoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
