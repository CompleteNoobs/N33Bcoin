...
# TestNode: A peer we use to send messages to n33bcoind, and store responses.
...
class CompactBlocksTest(N33BcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes n33bcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that n33bcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for n33bcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # n33bcoind will not send blocktxn responses for blocks whose height is
