...
'''
This reimplements tests from the n33bcoinj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure n33bcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure n33bcoind isn't accepting b28
        ...
        #    Low-S and High-S values (whereas the n33bcoin code has custom code which does so);
