...
/** N33Bcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class N33BcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit N33BcoinUnits(QObject *parent);

    /** N33Bcoin units.
      @note Source: https://en.n33bcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef N33BcoinUnits::Unit N33BcoinUnit;
