...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, N33BcoinUnits::SeparatorStyle separators=N33BcoinUnits::separatorStandard) const;
