 ...
 * between n33bcoind, and n33bcoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/n33bcoin/n33bcoin>";
    const std::string URL_WEBSITE = "<https://n33bcoincore.org>";
...
/** Sanity checks
 *  Ensure that N33Bcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single N33Bcoin process is using the data directory.
