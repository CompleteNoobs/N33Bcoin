...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s n33bcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  n33bcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded n33bcoin transaction") + "\n" +
              "  n33bcoin-tx [options] -create [commands]   " + _("Create hex-encoded n33bcoin transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CN33BcoinAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CN33BcoinAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded n33bcoin transaction
