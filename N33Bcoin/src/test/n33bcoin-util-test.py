...
# Copyright 2016 The N33Bcoin Core developers
...
help_text="""Test framework for n33bcoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/n33bcoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "n33bcoin-util-test.json", buildenv)
