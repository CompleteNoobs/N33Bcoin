...
#define BOOST_TEST_MODULE N33Bcoin Test Suite

#include "test_n33bcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_n33bcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
