...
#if defined(NDEBUG)
# error "N33Bcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "N33Bcoin Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight == 1)
        ...
        nSubsidy = 333 * COIN;
    // Subsidy is cut in half every 33,333 blocks which will occur approximately every 69 days.
    nSubsidy >>= halvings;
    return nSubsidy;
}
...
void ThreadScriptCheck() {
    RenameThread("n33bcoin-scriptch");
