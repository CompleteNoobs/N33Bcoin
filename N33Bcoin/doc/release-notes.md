N33Bcoin Core version 0.14.3 is now available from:

  <https://n33bcoin.org/bin/n33bcoin-core-0.14.3/>
...
N33Bcoin Core is extensively tested on multiple operating systems using
...
N33Bcoin Core should also work on most other Unix-like systems but is not
...
N33Bcoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
the vulnerable versions to 0.14.3, 0.15.2 or 0.16.3 as soon as possible.

Known Bugs
==========

Since 0.14.0 the approximate transaction fee shown in N33Bcoin-Qt when using coin
...
- #10451 `3612219` contrib/init/n33bcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
