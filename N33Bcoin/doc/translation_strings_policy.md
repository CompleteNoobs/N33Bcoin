...
This document provides guidelines for internationalization of the N33Bcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `n33bcoin_en.ts` remains unchanged.
