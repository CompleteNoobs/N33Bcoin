N33Bcoin Core version 0.9.4 is now available from:

  https://n33bcoin.org/bin/0.9.4/
...
this update is incompatible with the N33Bcoin system and could lead to consensus
forks.

N33Bcoin Core released binaries from https://n33bcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~n33bcoin/+archive/ubuntu/n33bcoin
- A third-party or self-compiled N33Bcoin Core

upgrade to N33Bcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
