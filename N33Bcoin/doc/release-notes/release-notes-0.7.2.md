N33Bcoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/n33bcoin/files/N33Bcoin/n33bcoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused N33Bcoin-Qt to crash on Windows when exiting.
