N33Bcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/n33bcoin/files/N33Bcoin/n33bcoin-0.8.4/
...
code, causing the N33Bcoin-Qt or n33bcoind process to crash.
Bloom filters were introduced with version 0.8, so versions 0.8.0
through 0.8.3 are vulnerable to this critical denial-of-service attack.

A constant-time algorithm is now used to check RPC password
guess attempts; fixes https://github.com/n33bcoin/n33bcoin/issues/2838
(CVE-2013-4165)
...
Linux: clicking on n33bcoin: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of N33Bcoin against Boost versions 1.50-1.52.
