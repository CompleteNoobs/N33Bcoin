N33Bcoin Core version 0.13.2 is now available from:

  <https://n33bcoin.org/bin/n33bcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update n33bcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow n33bcoin-tx to create v2 transactions (btcdrak)
