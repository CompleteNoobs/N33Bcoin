N33Bcoin Core version 0.13.0 is now available from:

  <https://n33bcoin.org/bin/n33bcoin-core-0.13.0/>
...
- Adding `dbcache=100` in n33bcoin.conf
...
n33bcoin-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/n33bcoin-cli -stdin walletpassphrase
    mysecretcode
    120
...
Various code modernizations have been done. The N33Bcoin Core code base has
...
compatible peers.
[BIP 152](https://github.com/n33bcoin/bips/blob/master/bip-0152.mediawiki)
...
HD wallets are incompatible with older versions of N33Bcoin Core.

[Pull request](https://github.com/n33bcoin/n33bcoin/pull/8035/files), [BIP 32](https://github.com/n33bcoin/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/n33bcoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/n33bcoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/n33bcoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/n33bcoin/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of N33Bcoin Core is expected that
...
Witness)] (https://github.com/n33bcoin/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/n33bcoin/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
The two phases are distinct in the N33Bcoin-Qt GUI. During the first one,
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/n33bcoin/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/n33bcoin/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/n33bcoin/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/n33bcoin/n33bcoin/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for n33bcoin-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to n33bcoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add n33bcoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: n33bcoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from n33bcoind (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the N33Bcoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for n33bcoind procs (MarcoFalke)
...
- #8164 `0f24eaf` [N33Bcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of n33bcoind startup (laanwj)
...
- #7975 `fc23fee` Update n33bcoin-core GitHub links (MarcoFalke)
