N33Bcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/n33bcoin/files/N33Bcoin/n33bcoin-0.5.4/
...
http://gitorious.org/n33bcoin/n33bcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix N33Bcoin-Qt notifications under Growl 1.3.
Increase required age of N33Bcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxN33Bcoin properly when installing N33Bcoin-Qt over it. (Windows)
