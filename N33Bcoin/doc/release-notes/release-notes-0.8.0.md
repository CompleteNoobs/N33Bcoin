N33Bcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/n33bcoin/files/N33Bcoin/n33bcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the N33Bcoin
...
New/changed settings (command-line or n33bcoin.conf file)
--------------------------------------------------------
