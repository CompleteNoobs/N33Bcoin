N33Bcoin Core version 0.10.4 is now available from:

  <https://n33bcoin.org/bin/n33bcoin-core-0.10.4/>
...
- #6953 `43c2789` Split n33bcoin-tx into its own package
- #6953 `dfe0d4d` Include n33bcoin-tx binary on Debian/Ubuntu
